...
/**
 * This class is used to create a PacMan object. It extends
 * the Mover class and includes an array of ImageIcons constants 
 * for the various states of PacMan.
...
public class PacMan extends Mover {
	...
	public PacMan() {
		...
		this.setIcon(IMAGE[0][0]); //set PacMan to left closed whe game starts
	}
}
